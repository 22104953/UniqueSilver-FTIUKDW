...
<body>
    ...
    <div class="div3">
        ...
        <div class="div4">
          <div><a href="index_member.php">BERANDA</a><a href="aboutus_member.php">TENTANG KAMI</a><a href="contactus_member.php">HUBUNGI KAMI</a><a href="order_member.php">INFO ORDER</a><a href="shipping_member.php">INFO PENGIRIMAN</a></div>
        </div>
      </div>
    </div>
    <div class="div6">
  ...
  <div class="middle"><p>
   <span style="font-size: 12px;"><strong>Cara mudah berbelanja di Unique Silver</strong><br/>
    ...
    <div class="buttons">
      <table>
        <tr>
          <td align="right"><a onclick="location='index_member.php'" class="button"><span>Lanjut</span></a></td>
        </tr>
      </table>
    </div>
  </div>
