            ...
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                <td style="text-align: center; width: 250px; vertical-align: top;">
                  <a href="image/product/anting/AN0001-500x500.jpg" title="Rectanglular Pave" class="thickbox"><img src="image/product/anting/AN0001-250x250.jpg" title="Rectanglular Pave" alt="Rectanglular Pave" id="image" style="margin-bottom: 3px;" /></a><br />
                  <span style="font-size: 11px;">Klik untuk memperbesar</span>
                </td>
                <td style="padding-left: 15px; width: 296px; vertical-align: top;">
                  <table width="100%">
                    ...
                    <tr>
                      <td><a href="http://facebook.com/"><img src="style/image/like.jpeg" height="25" width="60"></a></td>
                      <td></td>
                    </tr>
                  </table>
                  <div class="content">
