...
<body>
    <div id="container">
      <div id="header">
        ...
        <div class="div4">
          <div><a href="index.php">BERANDA</a><a href="aboutus.php">TENTANG KAMI</a><a href="contactus.php">HUBUNGI KAMI</a><a href="order.php">INFO ORDER</a><a href="shipping.php">INFO PENGIRIMAN</a></div>
        </div>
      </div>
    </div>
    <div class="div6">
  ...
  <div class="middle"><p>
   <span style="font-size: 12px;"><strong>Cara mudah berbelanja di Unique Silver</strong><br/>
    ...
    <div class="buttons">
      <table>
        <tr>
          <td align="right"><a onclick="location='index.php'" class="button"><span>Lanjut</span></a></td>
        </tr>
      </table>
    </div>
  </div>
