...
<div class="box">
  ...
  <div class="middle">
        <table cellpadding="2" cellspacing="0" style="width: 100%;">
            ...
            <tr>
              <td valign="top" width="1"><a href="cn0001_member_member.php"><img src="image/data/chace/CN0001.jpg"/></a></td>
...
<div id="content">
  <div class="top">
   ...
   <table class="list">
            <tr>
              <td width="25%">
                  <a href="an0017_member.php"><img src="image/product/anting/AN0017-120x120.jpg" title="Red Cubic Zirconia" alt="Red Cubic Zirconia" /></a><br />
                  <a href="an0017_member.php">Red Cubic Zirconia</a><br />
                  <span style="color: #999; font-size: 11px;">AN0017</span><br />
                  <span style="color: #900; font-weight: bold;">Rp.260,000.00</span><br />
              </td>
              <td width="25%">
                  <a href="an0018_member.php"><img src="image/product/anting/AN0018-120x120.jpg" title="amethyst droplets" alt="amethyst droplets" /></a><br />
                  <a href="an0018_member.php">amethyst droplets</a><br />
                  <span style="color: #999; font-size: 11px;">AN0018</span><br />
                  <span style="color: #900; font-weight: bold;">Rp.260,000.00</span><br />
              </td>
              <td width="25%">
                  <a href="an0019_member.php"><img src="image/product/anting/AN0019-120x120.jpg" title="Cultured Pearl" alt="Cultured Pearl" /></a><br />
                  <a href="an0019_member.php">Cultured Pearl</a><br />
                  <span style="color: #999; font-size: 11px;">AN0019</span><br />
                  <span style="color: #900; font-weight: bold;">Rp.260,000.00</span><br />
              </td>
              <td width="25%">
                  <a href="an0020_member.php"><img src="image/product/anting/AN0020-120x120.jpg" title="Earrings adorned" alt="Earrings adorned" /></a><br />
                  <a href="an0020_member.php">Earrings adorned</a><br />
                  <span style="color: #999; font-size: 11px;">AN0020</span><br />
                  <span style="color: #900; font-weight: bold;">Rp.260,000.00</span><br />
                </td>
            </tr>
          </table>
    <div class="page"><div class="link"> <a href="anting_member.php">1</a>  <b>2</b></div>
  </div>
  <div class="bottom">
    <div class="left"></div>
    <div class="right"></div>
    ...
    <div id="footer">
      ...
      <div class="div4">
        ...
        <a href="syarat_member_member.php">SYARAT &amp; KETENTUAN</a>
      </div>
    </div>
